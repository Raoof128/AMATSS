...
- Follow the project safety constraints: simulation-only, no real exploitation, scanning, or payload execution.
- Keep code modular, documented, and aligned to the specified architecture.
- Prefer structured logging and clear interfaces between agents.
- Maintain a clean, production-ready layout suitable for a public portfolio.
